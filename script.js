...
const btns = document.querySelectorAll('.box_1[data-color]'); // Исправленный селектор

const pictures = {
    dessert: "./desert_titan.webp",
    natural: "./natural_titan.webp",
    white: "./white_titan.webp",
    black: "./black_titan.webp"
};
